...
class TestAdminApiHandler(unittest.TestCase):
	...
	# Did not mean to push these yesterday.
	# UPDATE: Filter though all build_url(...) logic.
	# Also update everything with type checks? Unsure why I didn't do it earlier or
	# why I have a hunch to do it now. Ugh, python.
	# Just let me be a soulless java dev like I was born to be.
 	# build_url test(s)
